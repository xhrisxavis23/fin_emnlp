...
class QSettings(BaseSettings):
    ...
    provider_uri: str = "~/.qlib/qlib_data/sh_sp500_qlib"
...
_default_config = {
    ...
    #   # str
    #   "~/.qlib/stock_data/sh_sp500_qlib"
    #   # dict
    #   {"day": "~/.qlib/stock_data/sh_sp500_qlib", "1min": "~/.qlib/stock_data/sh_sp500_qlib_1min"}
...
HIGH_FREQ_CONFIG = {
    "provider_uri": "~/.qlib/qlib_data/sh_sp500_qlib_1min",
    "dataset_cache": None,
