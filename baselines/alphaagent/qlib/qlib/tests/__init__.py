...
class TestAutoData(unittest.TestCase):
    _setup_kwargs = {}
    provider_uri = "~/.qlib/qlib_data/sh_sp500_qlib_simple"  # target_dir
    provider_uri_1day = "~/.qlib/qlib_data/sh_sp500_qlib"  # target_dir
    provider_uri_1min = "~/.qlib/qlib_data/sh_sp500_qlib_1min"
