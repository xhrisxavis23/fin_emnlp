...
sh_sp500_qlib_DIR = DATA_ROOT_DIR / "cn"
CN_FEATURE_DATA_DIR = sh_sp500_qlib_DIR / "processed"
CN_ORDER_DIR = sh_sp500_qlib_DIR / "order" / "test"
CN_POLICY_WEIGHTS_DIR = sh_sp500_qlib_DIR / "weights"
...
def test_cn_ppo_strategy():
    ...
    backtest(
        partial(SingleAssetOrderExecutionSimple, data_dir=sh_sp500_qlib_DIR, ticks_per_step=30),
        state_interp,
        action_interp,
        orders,
        policy,
