...
```bash
# daily data
python get_data.py qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --region cn

# 1min  data (Optional for running non-high-frequency strategies)
python get_data.py qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib_1min --region cn --interval 1min
```
...
```bash
python get_data.py qlib_data --name qlib_data_simple --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --region cn
```
...
provider_uri = "~/.qlib/qlib_data/sh_sp500_qlib"  # target_dir
...
tar -zxvf qlib_bin.tar.gz -C ~/.qlib/qlib_data/sh_sp500_qlib --strip-components=2
```
