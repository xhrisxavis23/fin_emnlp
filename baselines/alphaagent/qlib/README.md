...
mkdir -p ~/.qlib/qlib_data/sh_sp500_qlib
tar -zxvf qlib_bin.tar.gz -C ~/.qlib/qlib_data/sh_sp500_qlib --strip-components=1
...
### Get with module
  ```bash
  # get 1d data
  python -m qlib.cli.data qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --region cn

  # get 1min data
  python -m qlib.cli.data qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib_1min --region cn --interval 1min
...
- Run the initialization code and get stock data:
  ...
  # Initialization
  mount_path = "~/.qlib/qlib_data/sh_sp500_qlib"  # target_dir
...
3. At this point you are in the docker environment and can run the qlib scripts. An example:
    ```bash
    >>> python scripts/get_data.py qlib_data --name qlib_data_simple --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --interval 1d --region cn
