#!/bin/bash
################################################################################
# US Market (SP500) Pipeline Runner (LOCAL OpenAI-compatible LLM)
#
...
# Usage:
#   ./run_us_qwen3_8b.sh
#   ./run_us_qwen3_8b.sh "Short-term mean reversion after panic selling" --outer-loop 3
################################################################################
...
echo "=================================================="
echo "🇺🇸 US Market (SP500) + Local LLM"
echo "=================================================="
