...
### Get Qlib data(`bin file`)
  ...
  - parameters:
    - `target_dir`: save dir, by default *~/.qlib/qlib_data/sh_sp500_qlib_5min*
     ...
     - parameters:
          ...
          - `qlib_data_1d_dir`: qlib directory(1d data)
            ...
            ```
                ...
                python scripts/get_data.py qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --interval 1d --region cn --version v3
            ```
      - examples:
        ```bash
        # normalize 5min cn
        python collector.py normalize_data --qlib_data_1d_dir ~/.qlib/qlib_data/sh_sp500_qlib --source_dir ~/.qlib/stock_data/source/hs300_5min_original --normalize_dir ~/.qlib/stock_data/source/hs300_5min_nor --region HS300 --interval 5min
        ```
