...
class Run(BaseRun):
    ...
    def normalize_data(
        ...
        ---------
            ...
            $ python collector.py normalize_data --qlib_data_1d_dir ~/.qlib/qlib_data/sh_sp500_qlib --source_dir ~/.qlib/stock_data/source_cn_1min --normalize_dir ~/.qlib/stock_data/normalize_cn_1min --region CN --interval 1min
        """
    ...
    def normalize_data_1d_extend(
        ...
        Examples
        ---------
            $ python collector.py normalize_data_1d_extend --old_qlib_dir ~/.qlib/qlib_data/sh_sp500_qlib --source_dir ~/.qlib/stock_data/source --normalize_dir ~/.qlib/stock_data/normalize --region CN --interval 1d
        """
