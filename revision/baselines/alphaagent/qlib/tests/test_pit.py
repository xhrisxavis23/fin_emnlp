...
class TestPIT(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        sh_sp500_qlib_dir = str(QLIB_DIR.joinpath("sh_sp500_qlib").resolve())
        pit_dir = str(SOURCE_DIR.joinpath("pit").resolve())
        pit_normalized_dir = str(SOURCE_DIR.joinpath("pit_normalized").resolve())
        GetData().qlib_data(
            name="qlib_data_simple", target_dir=sh_sp500_qlib_dir, region="cn", delete_old=False, exists_skip=True
        )
