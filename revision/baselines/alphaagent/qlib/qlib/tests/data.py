...
class GetData:
    ...
    def download_data(self, file_name: str, target_dir: [Path, str], delete_old: bool = True):
        ...
        # get cn csv data
        python get_data.py download_data --file_name csv_data_cn.zip --target_dir ~/.qlib/csv_data/sh_sp500_qlib
    ...
    def qlib_data(
        self,
        name="qlib_data",
        target_dir="~/.qlib/qlib_data/sh_sp500_qlib",
        version=None,
        interval="1d",
        region="cn",
        delete_old=True,
        ...
        ---------
        # get 1d data
        python get_data.py qlib_data --name qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib --interval 1d --region cn
        ...
        # get 1min data
        python get_data.py qlib_data --name qlib_data --target_dir ~/.qlib/qlib_data/sh_sp500_qlib_1min --interval 1min --region cn
